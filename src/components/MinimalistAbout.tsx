          ...
          <div className="space-y-8">
            ...
            <motion.div className="prose prose-lg max-w-none" variants={itemVariants}>
              <p className="text-gray-700 leading-relaxed">
                ...
                or research, you'll find me learning something new, involved in community work, or playing ping pong. I am an avid ping pong player, especially fascinated 
                by the hand-eye coordination and reflex involved in playing it.
              </p>
            </motion.div>
