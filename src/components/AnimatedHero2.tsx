          ...
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              <div className="space-y-4">
                ...
                >
                  <span className="bg-purple-50 dark:bg-purple-900/20 text-[#7b61ff] dark:text-[#7b61ff] px-4 py-2 rounded-full text-sm font-medium">
                    Welcome
                  </span>
                </motion.div>
                ...
                >
                  Hi, I'm{' '}
                  <span className="text-[#7b61ff] block sm:inline mt-2 sm:mt-0">
                    Ibrahim
                  </span>
                </motion.h1>
              ...
              >
                <Button
                  size="lg"
                  className="bg-[#7b61ff] hover:bg-purple-600 text-white px-4 py-2.5 sm:px-8 sm:py-3 rounded-full font-semibold shadow-lg hover:shadow-xl transition-all duration-300 flex items-center gap-1 sm:gap-2 flex-1 sm:flex-none sm:min-w-[160px] h-11 sm:h-12"
                ...
                <Button
                  variant="outline"
                  size="lg"
                  className="border-2 border-[#7b61ff] text-[#7b61ff] hover:bg-[#7b61ff] hover:text-white px-4 py-2.5 sm:px-8 sm:py-3 rounded-full font-semibold transition-all duration-300 flex-1 sm:flex-none sm:min-w-[160px] h-11 sm:h-12"
            ...
            >
              ...
              >
                ...
                <motion.div
                  className="absolute inset-0 rounded-full bg-[#7b61ff] opacity-15"
                  animate={{
                    rotate: [0, 360],
                    scale: [1, 1.1, 1],
                  }}
