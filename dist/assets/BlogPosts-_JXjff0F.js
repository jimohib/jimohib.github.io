import{j as e}from"./ui-CdTVB-iY.js";import{c as y,d as b,L as r}from"./index-BSzzCPdN.js";import{A as l}from"./arrow-left-CvNVTw1c.js";import{C as x,a as v}from"./clock-B2fl-AkB.js";import"./vendor-DpO94axI.js";/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const j=y("User",[["path",{d:"M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2",key:"975kel"}],["circle",{cx:"12",cy:"7",r:"4",key:"17ys0d"}]]),m={"culturally-sensitive-ai-social-robotics":{id:1,title:"Building Culturally Sensitive Humanoids: Lessons from Social Robotics",excerpt:"Exploring how cultural context shapes human-robot interactions and the importance of designing AI systems that respect diverse cultural norms and communication styles.",content:`
...
*This work is part of my ongoing research at Carnegie Mellon University's Human-Robot Interaction Lab, focusing on developing more inclusive and culturally adaptive AI systems.*
    `,date:"2024-12-15",readTime:8,category:"AI Research",slug:"culturally-sensitive-ai-social-robotics",author:"Ibrahim"},"future-hri-africa":{id:2,title:"The Future of Human-Robot Interaction in Africa",excerpt:"Discussing the unique opportunities and challenges for implementing social robotics in African contexts, with insights from ongoing research projects.",content:`
## Introduction
...
*This work is part of my ongoing research at Carnegie Mellon University's Human-Robot Interaction Lab, focusing on developing more inclusive and culturally adaptive AI systems.*
    `,date:"2024-11-28",readTime:6,category:"Robotics",slug:"future-hri-africa",author:"Ibrahim"}},T=()=>{const{slug:n}=b();if(!n||!m[n])return e.jsx("div",{className:"min-h-screen bg-gray-50 flex items-center justify-center",children:e.jsxs("div",{className:"text-center",children:[e.jsx("h1",{className:"text-2xl font-bold mb-4 text-gray-900",children:"Post Not Found"}),e.jsx("p",{className:"text-gray-600 mb-6",children:"The blog post you're looking for doesn't exist."}),e.jsxs(r,{to:"/blog",className:"inline-flex items-center text-[rgb(10,93,128)] hover:text-blue-700 font-medium transition-colors",children:[e.jsx(l,{className:"mr-2 h-4 w-4"}),"Back to Blog"]})]})});const i=m[n],d=o=>new Date(o).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"}),h=o=>{const c=o.trim().split(`
`),s=[];return c.forEach((g,a)=>{var u;const t=g.trim();if(t.startsWith("# "))s.push(e.jsx("h1",{className:"text-3xl font-bold mb-6 text-gray-900",children:t.slice(2)},a));else if(t.startsWith("## "))s.push(e.jsx("h2",{className:"text-2xl font-bold mb-4 mt-8 text-gray-900",children:t.slice(3)},a));else if(t.startsWith("### "))s.push(e.jsx("h3",{className:"text-xl font-semibold mb-3 mt-6 text-gray-900",children:t.slice(4)},a));else if(t.startsWith("- **")&&t.includes("**")){const p=((u=t.match(/\*\*(.*?)\*\*/))==null?void 0:u[1])||"",f=t.replace(/- \*\*.*?\*\*/,"").trim();s.push(e.jsxs("li",{className:"mb-2",children:[e.jsx("strong",{className:"text-gray-900",children:p}),e.jsx("span",{className:"text-gray-700",children:f})]},a))}else t.startsWith("- ")?s.push(e.jsx("li",{className:"mb-2 text-gray-700",children:t.slice(2)},a)):t.startsWith("*")&&t.endsWith("*")?s.push(e.jsx("p",{className:"italic text-gray-600 border-l-4 border-[rgb(10,93,128)] pl-4 mb-4",children:t.slice(1,-1)},a)):t==="---"?s.push(e.jsx("hr",{className:"my-8 border-gray-200"},a)):t===""?s.push(e.jsx("br",{},a)):s.push(e.jsx("p",{className:"mb-4 text-gray-700 leading-relaxed",children:t},a))}),s};return e.jsxs("div",{className:"min-h-screen bg-gray-50",children:[e.jsx("div",{className:"bg-white border-b border-gray-200",children:e.jsx("div",{className:"container mx-auto px-4 py-6",children:e.jsxs(r,{to:"/blog",className:"inline-flex items-center text-[rgb(10,93,128)] hover:text-blue-700 font-medium transition-colors mb-6",children:[e.jsx(l,{className:"mr-2 h-4 w-4"}),"Back to Blog"]})})}),e.jsx("article",{className:"container mx-auto px-4 py-12 max-w-4xl",children:e.jsxs("div",{className:"bg-white rounded-lg shadow-sm border border-gray-200 p-8",children:[e.jsxs("header",{className:"mb-8",children:[e.jsxs("div",{className:"flex flex-wrap items-center gap-4 text-sm text-gray-500 mb-4",children:[e.jsxs("span",{className:"flex items-center gap-1",children:[e.jsx(x,{className:"h-4 w-4"}),d(i.date)]}),e.jsxs("span",{className:"flex items-center gap-1",children:[e.jsx(v,{className:"h-4 w-4"}),i.readTime," min read"]}),e.jsxs("span",{className:"flex items-center gap-1",children:[e.jsx(j,{className:"h-4 w-4"}),i.author]}),e.jsx("span",{className:"text-[rgb(10,93,128)] font-medium",children:i.category})]}),e.jsx("h1",{className:"text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 leading-tight mb-4",children:i.title}),e.jsx("p",{className:"text-lg md:text-xl text-gray-600 leading-relaxed",children:i.excerpt})]}),e.jsx("div",{className:"w-full h-px bg-gradient-to-r from-transparent via-gray-300 to-transparent mb-8"}),e.jsx("div",{className:"prose prose-lg max-w-none",children:e.jsx("div",{className:"space-y-4",children:h(i.content)})}),e.jsx("footer",{className:"mt-12 pt-8 border-t border-gray-200",children:e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs(r,{to:"/blog",className:"inline-flex items-center text-[rgb(10,93,128)] hover:text-blue-700 font-medium transition-colors",children:[e.jsx(l,{className:"mr-2 h-4 w-4"}),"Back to All Posts"]}),e.jsx(r,{to:"/#contact",className:"text-gray-600 hover:text-[rgb(10,93,128)] font-medium transition-colors",children:"Get in touch"})]})})]})})]})};export{T as default};
