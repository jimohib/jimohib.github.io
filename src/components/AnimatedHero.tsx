          ...
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              <div className="space-y-4">
                ...
                >
                  <span className="bg-blue-50 dark:bg-blue-900/20 text-[rgb(10,93,128)] dark:text-[rgb(10,93,128)] px-4 py-2 rounded-full text-sm font-medium">
                    Welcome
                  </span>
                </motion.div>
                ...
                >
                  Hi, I'm{' '}
                  <span className="text-[rgb(10,93,128)] block sm:inline mt-2 sm:mt-0">
                    Ibrahim
                  </span>
                </motion.h1>
              ...
              >
                <Button
                  size="lg"
                  className="bg-[rgb(10,93,128)] hover:bg-[rgba(41, 161, 212, 1)]-500 text-white px-4 py-2.5 sm:px-8 sm:py-3 rounded-full font-semibold shadow-lg hover:shadow-xl transition-all duration-300 flex items-center gap-1 sm:gap-2 flex-1 sm:flex-none sm:min-w-[160px] h-11 sm:h-12"
                ...
                <Button
                  variant="outline"
                  size="lg"
                  className="border-2 border-[rgb(10,93,128)] text-[rgb(10,93,128)] hover:bg-[rgb(10,93,128)] hover:text-white px-4 py-2.5 sm:px-8 sm:py-3 rounded-full font-semibold transition-all duration-300 flex-1 sm:flex-none sm:min-w-[160px] h-11 sm:h-12"
            ...
            >
              ...
              >
                ...
                <motion.div
                  className="absolute inset-0 rounded-full bg-[rgb(10,93,128)] opacity-35"
                  animate={{
                    rotate: [0, 360],
                    scale: [1, 1.1, 1],
                  }}
                ...
                <div className="relative z-10 w-64 h-64 sm:w-72 sm:h-72 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-full overflow-hidden border-4 border-white dark:border-gray-800 shadow-2xl mx-auto">
                  <OptimizedImage
                    src="/photo1.jpg"
                    alt="Ibrahim - Research Associate & AI Engineer"
